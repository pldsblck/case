...
В основе работы бота лежит мощная модель языкового искусственного интеллекта **Qwen 2.5 VL 72B**, предоставленная через платформу OpenRouter AI. Эта модель обладает следующими преимуществами:
